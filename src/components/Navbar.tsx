  ...
  import { AdminProfile } from "@/components/admin/AdminProfile"; // Import AdminProfile component
  import { StudentProfile } from "@/components/student/StudentProfile"; // Import StudentProfile component
  ...
  export function Navbar({ name, role }: NavBarProps) {
    ...
    const [profileOpen, setProfileOpen] = useState(false); // State to control profile modal visibility
