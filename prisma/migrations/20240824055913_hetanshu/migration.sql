/*
  ...
  - You are about to drop the column `batch` on the `StudentDetails` table. All the data in the column will be lost.
  - You are about to drop the column `contactNumber` on the `StudentDetails` table. All the data in the column will be lost.
  - You are about to drop the column `dateOfBirth` on the `StudentDetails` table. All the data in the column will be lost.

*/
-- AlterTable
ALTER TABLE "StudentDetails" DROP COLUMN "batch",
...
-- AddForeignKey
ALTER TABLE "StudentDetails" ADD CONSTRAINT "StudentDetails_batchId_fkey" FOREIGN KEY ("batchId") REFERENCES "Batch"("batchId") ON DELETE SET NULL ON UPDATE CASCADE;
